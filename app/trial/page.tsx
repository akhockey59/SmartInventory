      ...
      >
        ...
        >
          ...
          <form onSubmit={handleSignup} className="space-y-6">
            ...
            {/* Password Input */}
            <div className="space-y-2">
              <label className="block text-sm font-medium text-white/80">Create Password</label>
              <motion.input
                whileFocus={{ scale: 1.01 }}
                type="password"
                value={password}
          ...
          <p className="text-sm text-white/60 text-center">
            By clicking "Create account" you agree to Sortly's{' '}
            <Link href="/terms" className="text-white hover:text-red-500">Terms & Conditions</Link>
            {' '}and{' '}
            <Link href="/privacy" className="text-white hover:text-red-500">Privacy Policy</Link>
          </p>
