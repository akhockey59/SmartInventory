  ...
  const sections = [
    {
      ...
      description: "Configure your low stock notifications",
    ...
    },
    {
      ...
      description: "Handle and respond to alerts effectively",
    ...
    },
    {
      ...
      description: "Automate your stock management",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className={`text-xl ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>
              Never run out of stock again with smart alerts
            </p>
          </motion.div>
